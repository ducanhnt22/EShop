...
namespace EShop.UserService.Application.Common.Behaviours;
    ...
    where TResponse : notnull
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            throw new AppExceptions("Validation errors occurred", allFieldErrors);
        }
...
public static class Validation
{
    public static async Task HandleValidationAsync<TRequest>(this IValidator<TRequest> validator, TRequest request)
    {
        ...
        if (failures.Any())
        {
            ...
            throw new AppExceptions(errorMessages);
        }
    }
}
