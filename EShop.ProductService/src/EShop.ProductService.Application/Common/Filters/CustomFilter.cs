using EShop.ProductService.Domain.Attributes;
using System.Linq.Dynamic.Core;
using System.Reflection;

namespace EShop.ProductService.Application.Common.Filters;

public static class CustomFilter
{
    public static IQueryable<TEntity> FilterEntity<TEntity>(this IQueryable<TEntity> source, TEntity entity)
    {
        if (entity == null)
        {
